...
header('location:manage-assigned-events.php');
}
else 
{
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line"><br>Assign Event</h4>
...
<label>Participant ID<span style="color:red;">*</span></label>
...
<div class="form-group">
<label>Event Code<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Assign Event</button>
