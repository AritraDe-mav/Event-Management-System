...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Assigned Events</h4>
    </div>
     <div class="row">
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            echo htmlentities("Participant Removed");
}
                                            ?></td>
                                            <td class="center">

                                            <a href="update-assigned-events.php?rid=<?php echo htmlentities($result->rid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> View</button> 
